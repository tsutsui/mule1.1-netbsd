...
extern int direct_output_for_insert (unsigned int);
...
extern int mchar_to_string (unsigned int, unsigned char *);
extern int string_to_mchar (unsigned char *, int);
...
extern void insert2 (const unsigned char *, int);
...
/* minibuf.c */
extern int scmp (unsigned char *, unsigned char *, int);
...
extern void fatal ();
#endif
extern void insert_chars (int *, int);
extern void ins_del_lines (int, int);
extern void move_cursor (int, int);
extern void output_chars (int *, int);
...
extern void init_codeconv (void);
...
extern void syms_of_codeconv (void);
...
extern void syms_of_mc (void);
extern void syms_of_ccl (void);
extern void syms_of_wnn (void);
