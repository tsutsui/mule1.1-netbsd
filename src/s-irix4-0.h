...
/* 92.7.21  modified for Mule Ver.0.9.5 by K.Handa <handa@etl.go.jp>
	Modified accoding to the Patch by
	rutt@paradise.asd.SGi.COM (John C. Ruttenberg) */
/* 92.11.6  modified for Mule Ver.0.9.7 by K.Shibata <shibata@sgi.co.jp>
	Support 310 COMPILER. */
