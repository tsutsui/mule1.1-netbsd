...
;;; modified by K.Handa  88.1.15
;;; Nemacs Ver.2.0
;;; 89.3.23  modified for Nemacs Ver.3.0 by K.Handa
;;; 91.11.29 modified for Nemacs Ver.4.0.0 by K.Handa <handa@etl.go.jp>
...
(if (= window-system-version 10)
  ...
  (setq command-switch-alist
	(append '(("-rn" . x-ignore-arg)
		  ...
		  ("-fnhbw" . x-ignore-arg)
		  ("-fnkana" . x-ignore-arg)
		  ("-fnroman" . x-ignore-arg)
		  ("-fncrl" . x-ignore-arg)
		  ("-fnltn5" . x-ignore-arg)
		  ("-fnjpold" . x-ignore-arg)
		  ("-fncn" . x-ignore-arg)
		  ("-fnjp" . x-ignore-arg)
		  ("-fnkr" . x-ignore-arg)
		  ("-fnjp2" . x-ignore-arg)
		  ("-fnbig5" . x-ignore-arg)
		  ("-lsp" . x-ignore-arg) ; 92.9.11 by K.Handa
		  ("-ecd" . x-ignore-arg)
		  ("-ecdltn1" . x-ignore-arg)
		  ("-ecdltn2" . x-ignore-arg)
		  ("-ecdltn3" . x-ignore-arg)
		  ("-ecdltn4" . x-ignore-arg)
		  ("-ecdgrk" . x-ignore-arg)
		  ("-ecdarb" . x-ignore-arg)
		  ("-ecdhbw" . x-ignore-arg)
		  ("-ecdkana" . x-ignore-arg)
		  ("-ecdroman" . x-ignore-arg)
		  ("-ecdcrl" . x-ignore-arg)
		  ("-ecdltn5" . x-ignore-arg)
		  ;;; end of patch
		  ("-wn" . x-ignore-arg)
		  ("-in" . x-ignore-arg)
		  ("-w" . x-ignore-arg)
