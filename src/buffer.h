...
/* 89.11.21 modified for attribute of characters by K.Handa */
...
struct buffer
  {
    ...
    Lisp_Object keymap, frontmap; /* 93.7.7 by K.Handa */
    /* This buffer's local abbrev table */
    Lisp_Object abbrev_table;
    /* This buffer's syntax table.  */
    Lisp_Object syntax_table;
    /* This buffer's category table.  91.12.4 by K.Handa */
...
/* 92.4.9 by K.Handa */
    /* Non-nil means display ctl chars with hexadecimal form (e.g. \xFF).
       Af for chars less than 0x20, ctl_arrow override this flag. */
    Lisp_Object ctl_hexa;
/* end of patch */
/* 92.8.2 by Y.Niibe */
    /* Non-nil means lines in the buffer are displayed right to left. */
    Lisp_Object display_direction;
/* end of patch */
...
/* 91.10.16 by S.Hirano, 91.12.6, 92.11.1, 93.3.3 by M.Higashida */
    ...
    Lisp_Object file_translation_mode;
#endif
#if (defined(MSDOS) && defined(FEPCTRL)) || (defined(WIN32) && defined(USE_IME))
    Lisp_Object fep_mode;
#endif
/* end of patch */
    /* Changes in the buffer are recorded here for undo.
       t means don't record anything.  */
    Lisp_Object undo_list;
/* 87.12.9, 89.3.10, 91.10.27  by K.Handa */
    Lisp_Object mc_flag;
    Lisp_Object file_coding_system;
/* 89.11.21, 92.1.30 by K.Handa */
    Lisp_Object attributed_region;
/* end of patch */
};
