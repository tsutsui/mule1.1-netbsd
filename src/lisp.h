...
extern Lisp_Object Fcategory_equal (Lisp_Object, Lisp_Object);
extern Lisp_Object Fcategory_table (void);
extern Lisp_Object Fcategory_table_p (Lisp_Object);
extern Lisp_Object Fchar_category (Lisp_Object, Lisp_Object);
extern Lisp_Object Fcheck_category (Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fcheck_category_at (Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fcopy_category_table (Lisp_Object);
extern Lisp_Object Fdefine_category_mnemonic (Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fdescribe_category (void);
...
extern Lisp_Object Funused_category_mnemonic (Lisp_Object);
extern Lisp_Object Fused_category_mnemonic (Lisp_Object);

/* Defined in ccl.c */
extern Lisp_Object Fccl_etime (void);
extern Lisp_Object Fccl_reg_count (void);
extern Lisp_Object Fccl_register (void);
extern Lisp_Object Fccl_reset_etime (void);
extern Lisp_Object Fccl_stack (void);
extern Lisp_Object Fccl_stack_size (void);

/* Defined in cmds.c */
extern Lisp_Object Fbackward_byte (Lisp_Object);
...
extern Lisp_Object Fforward_byte (Lisp_Object);
...
extern Lisp_Object Fself_insert_internal (Lisp_Object);
...
extern Lisp_Object Floadablep (Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fsref (Lisp_Object, Lisp_Object);
extern Lisp_Object Fsset (Lisp_Object, Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fchar_before (Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fmarker_point_type (Lisp_Object);
...
extern Lisp_Object Finsert_file_contents (Lisp_Object, Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fsi_insert_file_contents (Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fsi_write_region (int, Lisp_Object *);
extern Lisp_Object Fupdate_visited_file_modtime (void);
extern Lisp_Object Fverify_visited_file_modtime (Lisp_Object);
extern Lisp_Object Fwrite_region (int, Lisp_Object *);
...
extern Lisp_Object Flooking_at (Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fregexp_compile_pattern (Lisp_Object);
...
extern Lisp_Object Fminibuffer_extend_prompt (Lisp_Object);
...
extern Lisp_Object Fcurrent_front_map (void);
extern Lisp_Object Fcurrent_global_map (void);
extern Lisp_Object Fcurrent_local_map (void);
extern Lisp_Object Fdefine_key (Lisp_Object, Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fdefine_prefix_command (Lisp_Object);
extern Lisp_Object Fdescribe_bindings (void);
extern Lisp_Object Ffront_key_binding (Lisp_Object);
extern Lisp_Object Ffront_set_key (Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fuse_front_map (Lisp_Object);
...
extern Lisp_Object Fsi_open_network_stream (int, Lisp_Object *);
extern Lisp_Object Fsi_start_process (int, Lisp_Object *);
...
extern Lisp_Object Fsi_call_process (int, Lisp_Object *);
...
extern Lisp_Object Fchar_syntax_at (Lisp_Object);
extern Lisp_Object Fchar_syntax_match (Lisp_Object);
...
extern Lisp_Object Fupdate_mode_lines (void);
...
extern Lisp_Object Fx_get_compound_text (Lisp_Object);
...
extern Lisp_Object Fx_get_fontinfo (Lisp_Object);
...
extern Lisp_Object Fx_set_ccl (Lisp_Object, Lisp_Object);
extern Lisp_Object Fx_set_cursor_color (Lisp_Object);
extern Lisp_Object Fx_set_font (Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fx_set_foreground_color (Lisp_Object);
extern Lisp_Object Fx_set_internal_border_width (Lisp_Object);
extern Lisp_Object Fx_set_linespace (Lisp_Object);
extern Lisp_Object Fx_set_mouse_color (Lisp_Object);
extern Lisp_Object Fx_store_compound_text (Lisp_Object, Lisp_Object);
extern Lisp_Object Fx_store_cut_buffer (Lisp_Object);

/* 92.2.28, 92.12.18 by K.Handa */
/* defined in codeconv.c */
extern Lisp_Object Fb2m (Lisp_Object, Lisp_Object);
extern Lisp_Object Fe2s (Lisp_Object, Lisp_Object);
extern Lisp_Object Fcheck_code (Lisp_Object);
extern Lisp_Object Fcode_convert_region (Lisp_Object, Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fcode_detect_region (Lisp_Object, Lisp_Object);
extern Lisp_Object Fcoding_system_p (Lisp_Object);
extern Lisp_Object Fm2b (Lisp_Object, Lisp_Object);
extern Lisp_Object Fnon_nil_coding_system_p (Lisp_Object);
extern Lisp_Object Fs2e (Lisp_Object, Lisp_Object);
extern Lisp_Object Fset_code_priority (void);
extern Lisp_Object Fread_coding_system (Lisp_Object);
extern Lisp_Object Fread_non_nil_coding_system (Lisp_Object);
/* end of patch */

/* defined in mule.c */
extern Lisp_Object Fchar_boundary_p (Lisp_Object);
extern Lisp_Object Fchar_bytes (Lisp_Object);
extern Lisp_Object Fchar_component (Lisp_Object, Lisp_Object);
...
extern Lisp_Object Fmake_character (Lisp_Object, Lisp_Object, Lisp_Object, Lisp_Object);
extern Lisp_Object Fnew_character_set (int, Lisp_Object *);
