...
% 92.7.1   modified for Mule Ver.0.9.5 by S.Tomura <tomura@etl.go.jp>
%	Definition of 'xrdef' is modified.
% 93.7.29  modified for Mule Ver.0.9.8 by K.Handa <handa@etl.go.jp>
%	Name change of language specific file (texinfo-xx.tex -> texi-xx.tex).
...
%% Patch by S. Tomura 91-Mar-24
%% Above code does not work. The followings are new ones.
\gdef\xrdefR{}
\def\xrdef{\gdef\xrdefR{}\begingroup\catcode`\'=\other\xrdefA}
\def\xrdefA #1{\global\edef\xrdefR{\csname X#1\endcsname}\endgroup\xrdefB}
\def\xrdefB#1{\expandafter \gdef \xrdefR {#1}}
%% \def\xrdefA #1#2{\expandafter \gdef \csname X#1\endcsname {#2}\endgroup}
%% end of patch
