...
;;; Ver.18.57	modified for Mule Ver.0.9.0 by K.Handa 91.11.13
;;;		kanji-flag is changed to mc-flag
;;; Ver.18.53   created by S. Tomura 89-Apr-14
;;; Ver.18.52   created by S. Tomura 89-Mar-16
;;; Ver.18.50   created by S. Tomura 88-Jun-11
;;; Nemacs Ver.2.1  
;;; Ver.18.47a  modified by S. Tomura 88-Mar-23
;;;             kanji-flag is set to nil at debugger buffer
;;;
  ...
  (let (debugger-value
	...
	(save-excursion
	  (save-window-excursion
	    ...
	    (goto-char (point-min))
	    (debugger-mode)
	    ;;; patch by S. Tomura 89-Mar-17, 91.11.13 by K.Handa
	    (setq mc-flag nil)
	    ;;; end of patch
	    (delete-region (point)
			   (progn
