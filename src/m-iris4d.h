...
#ifdef IRIX5
#define LIB_STANDARD -lbsd -nocount -lc /usr/lib/crtn.o
#else
...
#undef _SYSTYPE_SVR4
#endif
#define LINKER /usr/bin/ld -elf -_SYSTYPE_SVR4 -require_dynamic_link _rld_new_interface -no_unresolved -Wx,-G 0 -g0 -call_shared -transitive_link
#define LD_SWITCH_SYSTEM LD_SWITCH_MACHINE -nocount /usr/lib/crt1.o -count
#endif
#endif
