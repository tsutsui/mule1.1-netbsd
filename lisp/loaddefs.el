...
;;;	Autoload specification for 'attribute' and 'kinsoku'.
;;; 92.11.19 modified for Mule Ver.0.9.6 by K.Handa <handa@etl.go.jp>
;;;	'attirbute-on-off-region' is also an autoloaded function.
;;; 93.5.17  modified for Mule Ver.0.9.8 by K.Handa <handa@etl.go.jp>
;;;	CCL support.
;;; 93.7.14  modified for Mule Ver.0.9.8 by K.Handa <handa@etl.go.jp>
;;;	TREX support.
;;; 93.9.2   modified for Mule Ver.1.1 by K.Miura <miura@cs.gunma-u.ac.jp>
;;;	autoload of CCL fixed.
...
;; 92.10.16 by K.Handa
(defvar user-init-filename ".emacs" "\
User's init file name.")

(defvar null-filename "/dev/null" "\
Null file name.")

(defvar backup-filename "~/%backup%~" "\
Backup file name.")
...
;;; so more common ones above are found faster.
				...
				;; 92.10.3 by M.Higashida -- for DOS
...

;; 92.10.18 by K.Handa
(defconst attribute-underline 1 "\
Mask bit for underline attribute.")
(defconst attribute-inverse 2 "\
Mask bit for inverse attribute.")
(defconst attribute-bold 4 "\
Mask bit for bold attribute.")

(autoload 'attribute-on-region "attribute"
  "\
...
directly may cause serious problems." t)

(autoload 'attribute-off-region "attribute"
  "\
Turn off ATTR for the characters within the region.
See the function attribute-on-region for the detail." t)

(autoload 'attribute-on-off-region "attribute" nil nil)	;92.11.19 by K.Handa

(autoload 'attribute-get-attribute "attribute"
  "\
Return a list of attribute ranges at POS.
An attribute range is a list of attribute type, the starting point,
and the ending point.
POS is optional argument and the default is the current point." t)

(autoload 'attribute-to-esc-sequence "attribute"
  "\
The current buffer's attribute information is converted to escape sequence
inserted at attributing point." t)

(autoload 'attribute-from-esc-sequence "attribute"
  "\
The escape sequence for attribute in the current buffer is conveted
to the real attribute information 'attributed-region'." t)

(autoload 'attribute-write-file "attribute"
  "\
Write current buffer with attribute information." t)

(autoload 'attribute-find-file "attribute"
  "\
Edit file FILENAME.  Attribute is set automatically." t)

(autoload 'kinsoku-shori "kinsoku")
(autoload 'kinsoku-shori-nobashi "kinsoku")
(autoload 'kinsoku-shori-chizime "kinsoku")
;; end of patch

;; 93.5.17 by K.Handa, 93.9.2 by K.Miura
(autoload 'ccl-compile "ccl"
  "\
Return a comiled code of CCL-PROGRAM.")

(autoload 'ccl-drive "ccl"
  "\
Convert SRC string by CCL-PROGRAM (should be a compiled one).")

;; 93.7.14 by K.Handa
(autoload 'regexp-compile "trex"
  "\
Not yet documented.")

(autoload 'regexp-word-compile "trex"
  "\
Not yet documented.")

