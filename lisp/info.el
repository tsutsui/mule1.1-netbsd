;; Ver.18.57	modified by K.Handa <handa@etl.go.jp> 92.3.4
;; Modified by Satoru Tomura(tomura@etl.go.jp)
(defconst jinfo-version "1.00")
;; Ver.1.00     modified by S.Tomura 91-Feb-28
...
;;; patch by S. Tomura 91-Feb-28, K.Handa 92.3.4
;;; (while (setq i (string-match "\n" str i))
;;;   (aset str i ?\ ))
    (if mc-flag
	(setq str (mc-normal-form-string str))
	(while (setq i (string-match "\n" str i))
	  (aset str i ?\ ))
	)
;;; end of patch 
