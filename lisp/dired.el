...
;;; 92.6.26  modified for Mule Ver.0.9.5 by T.Shingu <shingu@cpr.canon.co.jp>
;;;	In dired-find-file and dired-find-file-other-window,
;;;	prefix augument means file-coding-system is set interactively.
;;; 93.3.17  modified for Mule Ver.0.9.7.1 by T.Shingu <shingu@cpr.canon.co.jp>
;;;	In dired-find-file and dired-find-file-other-window,
;;;	handling of prefix augument updated.
;;; 94.2.23  modified for Mule Ver.1.1 by
;;;				A.Kon <kon@quincy.d1.bs2.mt.nec.co.jp>
;;;	`ls' is called with locale set to C.
...
;; 92.6.26, 93.3.17 by T.Shingu
(defun dired-find-file (&optional arg)
  "In dired, visit the file or directory named on this line."
  (interactive "ZCoding-system: ")
  (find-file (dired-get-filename) arg))
...
;; 92.6.26, 93.3.17 by T.Shingu
(defun dired-find-file-other-window (&optional arg)
  "In dired, visit this file or directory in another window."
  (interactive "ZCoding-system: ")
  (find-file-other-window (dired-get-filename) arg))
