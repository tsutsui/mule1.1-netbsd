...
/* 92.7.10  modified for Mule Ver.0.9.5 by K.Handa <handa@etl.go.jp>
	In init_eval_once(), max_lisp_eval_depth is set to 300. */
...
Lisp_Object Qload;		/* 91.11.1 by K.Handa */
...
definitions to shadow the loaded ones for use in file byte-compilation.")
  (register Lisp_Object form, Lisp_Object env)
{
...
static void
unbind_catch (struct catchtag *catch)
{
...
Both TAG and VALUE are evalled.")
  (register Lisp_Object tag, register Lisp_Object val)
{
...
static Lisp_Object
find_handler_clause (Lisp_Object handlers, Lisp_Object conditions, Lisp_Object sig, Lisp_Object data, Lisp_Object *debugger_value_ptr)
{
...
this does nothing and returns nil.")
  (Lisp_Object function, Lisp_Object file, Lisp_Object docstring, Lisp_Object interactive, Lisp_Object macro)
{
#ifdef NO_ARG_ARRAY
  Lisp_Object args[4];
#endif
...
/* ARGSUSED */
Lisp_Object
call1 (Lisp_Object fn, Lisp_Object arg)
{
  Lisp_Object val;
  struct gcpro gcpro1;
#ifdef NO_ARG_ARRAY
...
/* ARGSUSED */
Lisp_Object
call2 (Lisp_Object fn, Lisp_Object arg, Lisp_Object arg1)
{
  Lisp_Object val;
  struct gcpro gcpro1;
#ifdef NO_ARG_ARRAY
...
/* ARGSUSED */
Lisp_Object
call3 (Lisp_Object fn, Lisp_Object arg, Lisp_Object arg1, Lisp_Object arg2)
{
  Lisp_Object val;
  struct gcpro gcpro1;
#ifdef NO_ARG_ARRAY
...
/* ARGSUSED */
Lisp_Object
call4 (Lisp_Object fn, Lisp_Object arg, Lisp_Object arg1, Lisp_Object arg2, Lisp_Object arg3)
{
  Lisp_Object val;
  struct gcpro gcpro1;
#ifdef NO_ARG_ARRAY
...
before making  inhibit-quit  nil.");
  ...
  Qload = intern ("load");	/* 91.11.1 by K.Handa */
  staticpro (&Qload);		/* 91.11.1 by K.Handa */
