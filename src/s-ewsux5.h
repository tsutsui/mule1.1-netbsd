/* Definitions file for GNU Emacs running on NEC's EWS-UX/V(System V Release 2)
...
#define HAVE_TIMEVAL
/* EWS-UX/V does not have utimes  required in fileio.c */
#define USE_UTIME 
/*
...
#define LIB_STANDARD -ldir -lc
#define C_SWITCH_SYSTEM -I/usr/ucbinclude
